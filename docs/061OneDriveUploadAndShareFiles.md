...
Como o OneDrive utiliza o armazenamento do SharePoint, isto significa que tem as mesmas restrições e limitações do SharePoint.
...
## Carregue e guarde ficheiros e pastas no OneDrive

Pode fazer o upload a partir do seu browser, cliente de desktop OneDrive, guardado do Microsoft Office (Word, PowerPoint, Excel).

<br/>

O OneDrive suporta a visualização dos seguintes tipos de ficheiro:

| Tipo de ficheiro | Extensão |
| --- | --- | 
| Modelação/Impressão 3D | 3MF, COOL, GLB, GLTF, OBJ, STL |
| Apple | MOVIE, PAGES, PICT, SKETCH |
| Adobe | AI, PDF, PSB, PSD |
| Ficheiro de multimédia de áudio/vídeo | 3G2, 3GP, 3GPP, ASF, AVI, M2TS, M4A, M4V, MKV, MOV, MP3, MP4, MP4V, MTS, TS, WAV, WEBM, WMA, WMV |
| AutoCAD | DWG |
| AutoDesk | FBX |
| Motor de jogo BioWare | ERF |
| Ficheiro compactados | ZIP |
| Ficheiro compactados (Unix) | Z |
| Imagens Médicas DICOM  | DCM, DCM30, DICM, DICOM |
| Finale | PLY |
| HydroCAD| HCP |
| Formatos de imagem | GIF, HEIC, HEIF, JPEG, JPG, JPE, MEF, MRW, NEF, NRW, ORF, PANO, PEF, PNG, RW2, SPM, TIF, TIFF, XBM, XCF |
| Chave de licença | KEY |
| Ficheiro de registo | LOG | 
...
Se utilizar o Windows 10 ou Windows 11, o OneDrive pode já ter solicitado que inicie sessão para sincronizar os seus ficheiros.
...
1. Selecione o ícone da nuvem OneDrive na área de notificação, na extremidade direita da barra de tarefas.
