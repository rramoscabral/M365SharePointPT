...
> **Nota:** Não inclui todos os serviços na cloud.




| Aplicações ou Serviço | Descrição | 
| :---: | --- |
| Access <br/> ![Imagem quebrada](https://www.rramoscabral.com/training/assets/logos/MSAccess.png) | É um sistema de gestão de base de dados (SGBD) com interface gráfica de utilizador. Permite criar as suas próprias aplicações de base de dados a partir de modelos ou do zero.<br/>**Apenas está disponível para PC.**<br/><br/>Saber mais [**aqui**](https://www.microsoft.com/pt-pt/microsoft-365/access). |
| Advanced Threat Analytics<br/>![Imagem quebrada](https://www.rramoscabral.com/training/assets/logos/MSAdvancedThreatAnalytics.png)  | **O Advanced Threat Analytics (ATA) foi descontinuado em 12 de janeiro de 2021.**<br/><br/>Este produto é uma plataforma local que ajuda a proteger a sua empresa contra vários tipos de ataques cibernéticos direcionados avançados e ameaças internas. Detete ataques avançados no local em tempo real, aproveitando abordagens exclusivas para a análise de tráfego de rede e análise de comportamento de utilizadores e entidades. Reveja os alertas e atividades do utilizador para compreender os métodos de ataque e possíveis danos. Avalie a sua postura de segurança através da visibilidade total da configuração local da Active Directory, dos utilizadores e das contas de serviço que podem ser comprometidas devido a definições de segurança incorretas ou a uma falha no cumprimento das melhores práticas.<br/><br/>Saber mais [**aqui**](https://learn.microsoft.com/pt-pt/advanced-threat-analytics/what-is-ata) |
| Bookings<br/>![Logo Bookings](https://www.rramoscabral.com/training/assets/logos/MSBookings.png) | O Microsoft Bookings possui flexibilidade e opções de personalização para organizar agendas e gerir compromissos. Pode criar e gerir vários calendários do Bookings, cada um com a sua configuração exclusiva. Calendários diferentes podem ter diferentes estruturas de páginas, informações, funcionários e tipos de compromissos e comunicação.<br/><br/>Saber mais [**aqui**](https://www.microsoft.com/pt-pt/microsoft-365/business/scheduling-and-booking-app) |
| Delve<br/>![Imagem quebrada](https://www.rramoscabral.com/training/assets/logos/Delve.png)  | Faça a gestão do seu perfil do Microsoft 365 com o Delve. Agora, pode descobrir e organizar as informações mais relevantes para si em todas as suas aplicações do Microsoft 365.<br/><br/>Saber mais [**aqui**](https://go.microsoft.com/fwlink/p/?LinkID=2127981&clcid=0x816&culture=pt-pt&country=pt) |
| Microsoft Defender XDR<br/>![Imagem quebrada](https://www.rramoscabral.com/training/assets/logos/MicrosoftDefenderXDR.png)  | **Não substitui o antivírus instalado no computador.**<br><br>O Microsoft Defender XDR é um conjunto unificado de defesa empresarial pré e pós-violação que coordena nativamente a deteção, prevenção, investigação e resposta em endpoints, identidades, e-mails e aplicações para fornecer proteção integrada contra ataques sofisticados.<br/><br/>Saber mais [**aqui**](https://learn.microsoft.com/pt-pt/defender-xdr/microsoft-365-defender) |
| Microsoft Defender for Cloud Apps <br/>![Imagem quebrada](https://www.rramoscabral.com/training/assets/logos/MSCloudAppSecurity.png)  | Microsoft Defender for Cloud Apps anteriormente conhecido como Cloud App Security é um Cloud Access Security Broker (CASB) ou Agente de Segurança de Acesso à Cloud em português que suporta vários modos de implementação, incluindo a recolha de registos, conectores de API e proxy reverso. Fornece visibilidade avançada, controlo sobre a movimentação de dados e análises sofisticadas para identificar e combater as ciberameaças em todos os seus serviços de cloud da Microsoft e de terceiros.<br/><br/>Saber mais [**aqui**](https://www.microsoft.com/pt-pt/security/business/siem-and-xdr/microsoft-defender-cloud-apps) |
| Microsoft Defender para Endpoint<br/>![Imagem quebrada](https://www.rramoscabral.com/training/assets/logos/MSDefenderForEndpoint.png) | O Microsoft Defender para Endpoint oferece segurança de endpoint líder de mercado para Windows, macOS, Linux, Android, iOS e dispositivos de rede e ajuda a interromper rapidamente os ataques, a escalar os seus recursos de segurança e a desenvolver as suas defesas. É entregue à escala da cloud, com inteligência artificial integrada que analisa a inteligência de ameaças mais ampla do setor.<br/><br/>Saber mais [**aqui**](https://www.microsoft.com/pt-pt/security/business/endpoint-security/microsoft-defender-endpoint) |
| Microsoft Defender para Identidade <br/>![Imagem quebrada](https://www.rramoscabral.com/training/assets/logos/MSDefenderForEndpoint.png) | O Microsoft Defender para Identidade (anteriormente Azure Advanced Threat Protection, também conhecido como Azure ATP) é uma solução de segurança baseada na cloud que aproveita os sinais locais da Active Directory para identificar, detetar e investigar ameaças avançadas, identidades comprometidas e ações internas maliciosas direcionadas à sua organização. Proteja o seu património digital com a única plataforma de operações de segurança (SecOps) que unifica as capacidades totais de deteção e resposta alargada (XDR) e gestão de informações e eventos de segurança (SIEM).<br/><br/>Saber mais [**aqui**](https://www.microsoft.com/pt-pt/security/business/SIEM-and-XDR/microsoft-defender-for-identity) |
| Microsoft Defender para Office 365<br/> ![Imagem quebrada](https://www.rramoscabral.com/training/assets/logos/MSDefender365.png) | O Microsoft Defender para Office 365r é um conjunto unificado de defesa empresarial pré e pós-violação que coordena nativamente a deteção, prevenção, investigação e resposta em endpoints, identidades, emails e aplicações para fornecer proteção integrada contra ataques sofisticados.<br/><br/>Saber mais [**aqui**](https://www.microsoft.com/pt-pt/security/business/siem-and-xdr/microsoft-defender-office-365) |
| Microsoft Edge<br/>![Imagem quebrada](https://www.rramoscabral.com/training/assets/logos/MSEdge.png) | O Microsoft Edge (baseado no motor Chromium) é um navegador de Internet que substitui o Microsoft Edge Legacy (baseado no motor EdgeHTML) e também o Microsoft Internet Explorer. O Microsoft Edge não é o único browser que utiliza o Chromium o Google Chrome, Samsung Internet e Opera também o utilizam o Chromium.<br/><br/>Saber mais [**aqui**](https://www.microsoft.com/pt-pt/edge) |
...
| Planner<br/>![Imagem quebrada](https://www.rramoscabral.com/training/assets/logos/MSPlanner.png) | O Microsoft Planner é uma solução de quadros Kanban que simplifica a gestão de tarefas e listas de tarefas para equipas e está ligado entre aplicações Microsoft 365.<br/><br/>Saber mais [**aqui**](https://www.microsoft.com/pt-pt/microsoft-365/business/task-management-software) |
...
| Microsoft To Do<br/>![Imagem quebrada](https://www.rramoscabral.com/training/assets/logos/MSToDo.png) | A aplicação Microsoft To Do prepara-o para o sucesso, ajudando-o a gerir, priorizar e concluir as suas metas e tarefas.<br/><br/>Saber mais [**aqui**](https://www.microsoft.com/pt-pt/microsoft-365/microsoft-to-do-list-app) |
...
| [Office Casa e Negócios 2021](https://www.microsoft.com/pt-pt/microsoft-365/p/office-home-business-2021/cfq7ttc0hpn4?activetab=pivot:descri%C3%A7%C3%A3ogeraltab) | [Microsoft 365 Business Premium](https://www.microsoft.com/pt-pt/microsoft-365/business/microsoft-365-business-premium)  | [Microsoft 365 F3](https://www.microsoft.com/pt-pt/microsoft-365/enterprise/f3?activetab=pivot%3aoverviewtab) |
